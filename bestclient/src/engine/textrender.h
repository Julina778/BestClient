...
namespace FontIcons
{
    ...
    [[maybe_unused]] static const char *FONT_ICON_ANGLE_DOWN = "\xEF\x84\x87";
    [[maybe_unused]] static const char *FONT_ICON_ANGLES_UP = "\xEF\x84\x82";
    [[maybe_unused]] static const char *FONT_ICON_ANGLES_DOWN = "\xEF\x84\x83";
	...
	[[maybe_unused]] static const char *FONT_ICON_HEADPHONES = "\xEF\x80\xA5";
}
...
public:
	virtual std::vector<std::string> *GetCustomFaces() = 0; // BestClient
	virtual void SetCustomFace(const char *pFace) = 0; // BestClient
