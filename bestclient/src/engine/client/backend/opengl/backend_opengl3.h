...
{
protected:
	struct SWorldEditorProgram
	{
		CGLSLProgram *m_pProgram = nullptr;
		int m_LocTexture0 = -1;
		int m_LocTexture1 = -1;
		int m_LocParams = -1;
		int m_LocTexelSize0 = -1;
		int m_LocTexelSize1 = -1;
		int m_LocPassIndex = -1;
	};
	...
	SWorldEditorProgram m_WorldEditorProgram;
	TWGLuint m_WorldEditorVao = 0;
	...
	void Cmd_RenderPostProcess(const CCommandBuffer::SCommand_RenderPostProcess *pCommand) override;
