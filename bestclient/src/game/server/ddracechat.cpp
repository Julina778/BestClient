...
void CGameContext::ConSwap(IConsole::IResult *pResult, void *pUserData)
{
	...
	CPlayer *pSwapPlayer = pSelf->m_apPlayers[TargeBestClientId];
	...
	if(pSelf->m_World.m_Core.m_apCharacters[pResult->m_ClientId] == nullptr || pSelf->m_World.m_Core.m_apCharacters[TargeBestClientId] == nullptr)
	{
