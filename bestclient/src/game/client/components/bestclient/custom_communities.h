#ifndef GAME_CLIENT_COMPONENTS_BestClient_CUSTOM_COMMUNITIES_H
#define GAME_CLIENT_COMPONENTS_BestClient_CUSTOM_COMMUNITIES_H
...
private:
	...
	void ResetCustomCommunitiesState();
	bool HasPendingInfoTask() const;
