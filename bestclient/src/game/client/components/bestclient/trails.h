#ifndef GAME_CLIENT_COMPONENTS_BestClient_TRAILS_H
#define GAME_CLIENT_COMPONENTS_BestClient_TRAILS_H
...
private:
	...
	std::array<CTrailPart, 202> m_aTrailScratch;

	void ClearAllHistory();
	void ClearHistory(int ClientId);
	bool ShouldPredictPlayer(int ClientId);
	bool ShouldRenderClientTrail(int ClientId, bool Local, bool ZoomAllowed) const;
};
