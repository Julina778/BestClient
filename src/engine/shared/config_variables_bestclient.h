...
MACRO_CONFIG_INT(ClShowFlagsSize, al_show_flags_size, 80, 0, 150, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Size of tee stat indicators")
...
// Pie Menu
MACRO_CONFIG_INT(QmPieMenuEnabled, al_pie_menu_enabled, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable pie menu for player interactions")
MACRO_CONFIG_INT(QmPieMenuMaxDistance, al_pie_menu_max_distance, 400, 100, 2000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Maximum detection distance for nearest player")
MACRO_CONFIG_INT(QmPieMenuScale, al_pie_menu_scale, 100, 50, 200, CFGFLAG_CLIENT | CFGFLAG_SAVE, "UI scale percentage")
MACRO_CONFIG_INT(QmPieMenuOpacity, al_pie_menu_opacity, 80, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Menu opacity 0-100")
MACRO_CONFIG_STR(QmPieMenuRenameQueue, al_pie_menu_rename_queue, 512, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "")
MACRO_CONFIG_INT(QmPieMenuColorFriend, al_pie_menu_color_friend, 0xE64D66BF, 0, 0, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "")
MACRO_CONFIG_INT(QmPieMenuColorWhisper, al_pie_menu_color_whisper, 0x8059B3BF, 0, 0, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "")
MACRO_CONFIG_INT(QmPieMenuColorMention, al_pie_menu_color_mention, 0xD98033BF, 0, 0, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "")
MACRO_CONFIG_INT(QmPieMenuColorCopySkin, al_pie_menu_color_copy_skin, 0x408CCCBF, 0, 0, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "")
MACRO_CONFIG_INT(QmPieMenuColorSwap, al_pie_menu_color_swap, 0xCC4D4DBF, 0, 0, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "")
MACRO_CONFIG_INT(QmPieMenuColorSpectate, al_pie_menu_color_spectate, 0x738C99BF, 0, 0, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "")
MACRO_CONFIG_INT(QmPieMenuShowFriend, al_pie_menu_show_friend, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "")
MACRO_CONFIG_INT(QmPieMenuShowWhisper, al_pie_menu_show_whisper, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "")
MACRO_CONFIG_INT(QmPieMenuShowMention, al_pie_menu_show_mention, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "")
MACRO_CONFIG_INT(QmPieMenuShowCopy, al_pie_menu_show_copy, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "")
MACRO_CONFIG_INT(QmPieMenuShowSwap, al_pie_menu_show_swap, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "")
MACRO_CONFIG_INT(QmPieMenuShowSpec, al_pie_menu_show_spec, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "")
