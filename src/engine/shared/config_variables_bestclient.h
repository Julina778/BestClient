...
MACRO_CONFIG_INT(BcMusicPlayerVisualizerSensitivity, bc_music_player_visualizer_sensitivity, 100, 50, 2000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Music player visualizer sensitivity in percent (higher catches quieter audio)")
...
MACRO_CONFIG_INT(BcHudMusicPlayerX, bc_hud_music_player_x, 184, -1000, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "HUD editor X position for music player")
...
MACRO_CONFIG_INT(BcHudVoiceHudX, bc_hud_voice_hud_x, 4, -1000, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "HUD editor X position for voice HUD")
MACRO_CONFIG_INT(BcHudVoiceHudY, bc_hud_voice_hud_y, 122, -1000, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "HUD editor Y position for voice HUD")
...
MACRO_CONFIG_INT(BcHudVoiceMuteIconsX, bc_hud_voice_mute_icons_x, 160, -1000, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "HUD editor X position for voice mute icons")
...
MACRO_CONFIG_INT(BcHudChatY, bc_hud_chat_y, 273, -1000, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "HUD editor Y anchor position for ingame chat")
