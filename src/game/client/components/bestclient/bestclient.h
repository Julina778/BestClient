...
public:
	...
	enum EBestClientComponent
	{
		...
		COMPONENT_ALESSTYA_SKIN_STEALER,
		COMPONENT_ALESSTYA_SCOREBOARD_POINTS,
		COMPONENT_ALESSTYA_WEAPONS_PATH,
		COMPONENT_ALESSTYA_TEE_STATS,
		COMPONENT_ALESSTYA_PIE_MENU,
