...
private:
	...
	int GetHoveredOptionDynamic(const std::vector<EMenuOption> &EnabledOptions) const;
...
public:
	...
	void RenderSectorDynamic(EMenuOption Option, float InnerRadius, float OuterRadius, float StartAngle, float EndAngle, bool Highlighted, float Alpha);
